...
">
            ...
            ?>
                ...
                <a href="chi-tiet-sp.php?ma_hh=<?=$ma_hh?>"><span class="chi-tiet">CHI TIẾT</span></a>
                    ...
                    <a href="chi-tiet-sp.php?ma_hh=<?=$ma_hh?>"><img  src="../../bigshoes/css/admin/images/products/<?=$hinh?>" alt=""><span class='hang-moi'>Sản phẩm mới</span></a>
                    <div class="glow-wrap">
    <i class="glow"></i>
  </div>
                    <div class="text">
        ...
        <div class="row">
            ...
            <div class="col-md-12" style="padding-left: 0px;">
                ...
                <div class="owl-carousel owl-theme ">
                    ...
                    ?>
                    <div class="item">
                        <a href="chi-tiet-sp.php?ma_hh=<?=$ma_hh?>"><img style="width: 200px" src="../../bigshoes/css/admin/images/products/<?=$hinh?>" alt="ds"><span class='noi-bat'>HOT</span></a>
                    </div>
                        <?php } ?>
