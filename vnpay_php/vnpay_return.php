...
<html lang="en">
    <head>
        ...
        <!-- Bootstrap core CSS -->
        <link href="/bigshoes/vnpay_php/assets/bootstrap.min.css" rel="stylesheet"/>
        <!-- Custom styles for this template -->
        <link href="/bigshoes/vnpay_php/assets/jumbotron-narrow.css" rel="stylesheet">         
        <script src="/bigshoes/vnpay_php/assets/jquery-1.11.3.min.js"></script>
    </head>
    <body>
        <?php
        require_once("../../bigshoes/admin/dao/pdo.php");
        ...
        <div class="container">
            ...
            <div class="table-responsive">
                ...
                <div class="form-group">
                    ...
                    <label>
                        ...
                        if ($secureHash == $vnp_SecureHash) {
                            if ($_GET['vnp_ResponseCode'] == '00') {
                                ...
                                $conn = new mysqli("localhost","root","","bigshoes");
                                $taikhoan = '';
                    ...
                    <br>
                    <a href="https://localhost/bigshoes/trang-chinh/danh-sach-sp.php">
